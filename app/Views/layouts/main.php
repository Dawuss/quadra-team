...
<body class="bg-light">
    <nav class="navbar navbar-expand-md navbar-dark text-light" style="background-color: #0D47A1;color:white;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li><a class="nav-link <?= isset($page_title) && $page_title == 'Vacancies' ? 'active' : '' ?>" href="<?= base_url('Main/vacancies') ?>">Vacancies</a></li>
                    <li><a class="nav-link <?= isset($page_title) && $page_title == 'Applicants' ? 'active' : '' ?>" href="<?= base_url('Main/applicants') ?>">Applicants</a></li>
