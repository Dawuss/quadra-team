                ...
                <form action="<?= base_url('register') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        <div class="text-center">
                            <a href="<?= base_url('/Auth') ?>" class="text-decoration-none fw-bold">Already have an Account?</a><br>
                            <a href="<?= base_url('/Vacancy') ?>" class="text-decoration-none fw-bold">Back to Site</a>
                        </div>
                    </div>
                </form>
            </div>
